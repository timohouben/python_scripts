...
def getdata(tec_files):
    for k, file_name_ogs in enumerate(tec_files):
        ...
        for j, x in enumerate(sat_z_data_ogs):
            try:
                if sat_z_data_ogs[j][1] > sat_z_data_ogs[j+1][1]: # and sat_z_data_ogs[j+1][1] > sat_z_data_ogs[j+2][1] and sat_z_data_ogs[j+2][1] > sat_z_data_ogs[j+3][1]:# and sat_z_data_ogs[j+3][1] > sat_z_data_ogs[j+4][1] and sat_z_data_ogs[j+4][1] > sat_z_data_ogs[j+5][1]:
