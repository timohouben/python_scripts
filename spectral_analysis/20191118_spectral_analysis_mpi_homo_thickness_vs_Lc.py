...
e.g. 20191115_generate_ogs_homogeneous_mpi_thickness.py
...
Furthermore, the aquifer thickness will be derived from the distance of point
A to point D. The length of the connection from river and aquifer will be derived from the
length of the polyline river. Both will be added to the data frame.
