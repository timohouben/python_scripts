...
def printer(results):
    return str("The characteristic time scale of your aquifer lies between " + "{:.1f}".format(results[0]) + " and " + "{:.1f}".format(results[1]) + " days.\nThe length of your time series should be at least " + "{:.1f}".format(results[0]/10) + " days. You would capture the entire frequency response of your aquifer with a time series of " + "{:.1f}".format(results[1]/10) + " days.")
...
# row #5
calculate = Button(master,
                   text="Calculate tc and minimum length of time series!",
                   command=button_action, width=48)
