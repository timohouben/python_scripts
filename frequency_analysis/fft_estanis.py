...
def fft_psd(fft_data=fft_data,
            ...
            path_to_project='/Users/houben/PhD/transect/transect/ogs/confined/transient/rectangular/Groundwater@UFZ/Model_Setup_D_day_EVE/homogeneous/TEST/',
            single_file='TESTFILE',
            method='pyplotwelch',
...
fft_psd(fft_data=fft_data, recharge=recharge, method='pyplotwelch')