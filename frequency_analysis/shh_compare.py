...
fft_data = np.loadtxt(
    "/Users/houben/PhD/modelling/transect/ogs/confined/transient/rectangular/frequency/dupuit_flow/D_30_1000_30_whitenoise_D_18-D_30_homogeneous/head_ogs_obs_0400_mean.txt"
)
recharge = np.loadtxt(
    "/Users/houben/PhD/modelling/transect/ogs/confined/transient/rectangular/frequency/dupuit_flow/D_30_1000_30_whitenoise_D_18-D_30_homogeneous/rfd_curve#1.txt"
)
...
T = 30 * (1e-5)
x = 400
power_spectrum_anal = shh_analytical(
    power_spectrum_input, frequency_input, Sy, T, x, aquifer_length, m=2, n=2
)
