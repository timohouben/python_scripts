...
model domain with mpi4py. Every model setup ist first generated with a steady state
configuration, afterwards the OGS run starts, output is redirected into the
"steady" folder and input files are changed to input files with transient
settings.
...
3) Run the script with the following command from your cmd-line.
    ...
    python3 name_of_this_script.py the/working/directory number/of/slots
