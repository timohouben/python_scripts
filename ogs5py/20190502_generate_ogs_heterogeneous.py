...
recharge_list = ['/Users/houben/PhD/modelling/20190304_spectral_analysis_homogeneous/recharge_daily.txt', '/Users/houben/phd/modelling/recharge/realistic/recharge_daily_30years_seconds_mm_mHM_estanis_danube.txt']
        ...
        for mean in mean_list:
            for storage in storage_list:
                for recharge, rech_abv in zip(recharge_list,rech_abv_list):
                    ...
                    name='var_' + str(var) + '_len_' + str(len_scale) + '_mean_' + str(mean) + '_seed_' + str(seed) + '_stor_' + str(storage) + '_rech_' + str(rech_abv)
                    output = "output"
                    dim_no = 2
