...
time_steps = (
    100
)  # this is the value which is given in the ogs input file .tim. It will result in a total of 101 times because the initial time is added.
...
plt.suptitle(
    "Frequency analysis for " + str(obs_point) + " from ogs results.", fontsize=16
)
